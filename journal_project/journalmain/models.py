...
class JournalEntry(models.Model):
    ...
    created_at = models.DateTimeField(auto_now=True)
    updated_at = models.DateTimeField(auto_now=True)
    week_report = models.ForeignKey(Goal, on_delete=models.CASCADE, related_name='week_report', blank=True, null=True)
    month_report = models.ForeignKey(Goal, on_delete=models.CASCADE, related_name='month_report', blank=True, null=True)
